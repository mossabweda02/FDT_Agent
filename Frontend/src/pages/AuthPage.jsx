    ...
    <main className="auth-page">
        ...
        <section className="auth-visual-panel" aria-hidden="true">
          <div className="auth-hero-content">
            ...
            <p>
              Créez, vérifiez et gérez vos saisies hebdomadaires via une expérience
              conversationnelle sécurisée.
            </p>
          </div>
        ...
        <div className="auth-card-zone">
          <section className="auth-card" aria-label="Connexion FDT Agent">
            ...
            <div className="auth-restricted-note">
                ...
                <p>
                    Accès réservé aux membres de l’équipe Metam. Votre session Azure AD sera
                    utilisée pour authentifier les requêtes ERP.
                </p>
            </div>
          </section>
        </div>
