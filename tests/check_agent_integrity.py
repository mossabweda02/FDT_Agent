"""
tests/check_agent_integrity.py
====================
Ce script de test est conçu pour vérifier :
1. Les imports corrigés dans les modules modifiés (sql_validator, tools, system_prompt)
2. Le contenu du prompt système généré, en s'assurant que les règles et exemples corrigés sont bien présents.
3. Les exemples SQL pour s'assurer qu'ils respectent les règles.
4. Les outils définis dans tools_definitions ont bien leur fonction correspondante dans functions_tool.

Usage :
    py -m tests.check_agent_integrity
"""
...
def check_imports() -> bool:
    ...
    try:
        from backend.core.training_examples import format_examples_for_prompt, get_all_examples
    ...
    try:
        from backend.core.prompts import build_system_prompt, TOOLS_DEFINITIONS
...
def check_examples() -> bool:
    ...
    try:
        from backend.core.training_examples import (
            get_all_examples,
