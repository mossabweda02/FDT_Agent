...
========================================
ce script de test : 
- construit une banque de questions synthétiques couvrant un large éventail de cas d'usage 
- exécute plusieurs rounds de tests aléatoires pour valider la fonction sanitize_question
- affiche des rapports détaillés en cas d'échec, avec coloration console pour faciliter la lecture

Usage :
    py -m tests.test_question_sanitizer
"""
